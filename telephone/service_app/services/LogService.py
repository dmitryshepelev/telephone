...
class Code():
	...
	REGISTER_CALLBACK_ERR = 'REGISTER CALLBACK ERROR'
	INCOMING_INFO_ERR = 'INCOMING INFO ERROR'

	# PBXDataService
	GET_AUDIO_ERR = 'GET AUDIO ERROR'
	GET_BALANCE_ERR = 'GET BALANCE ERROR'
	GET_CALL_COST_ERR = 'GET CALL COST ERROR'
	REQUEST_CALLBACK_ERR = 'REQUEST CALLBACK ERROR'
	SIP_GETTING_ERR = 'SIP GETTING ERROR'

	# CommonService
	WRITE_TEMP_FILE_ERR = 'WRITE TEMP FILE ERROR'
	DELETE_TEMP_FILE_ERR = 'DELETE TEMP FILE ERROR'
